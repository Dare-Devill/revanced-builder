...
If you are on a PC, download the latest executable from [here](https://github.com/Dare-Devill/revanced-builder/releases/latest) or if you are on a Android device, please see [this](https://github.com/Dare-Devill/revanced-builder/wiki/How-to-use-revanced-builder-on-Android).
